...
public class listagemVIEW extends javax.swing.JFrame {
  ...
  public listagemVIEW() {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        if (idTexto.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Informe o ID do produto que deseja vender.");
            return;
        }
        ...
        try {
            ...
            javax.swing.JOptionPane.showMessageDialog(this, "O ID informado não é um número válido.");
        }
    ...
    private void listarProdutos() {
        try {
            ...
            for (int i = 0; i < listagemProdutos.size(); i++) {
                model.addRow(new Object[]{
                    listagemProdutos.get(i).getId(),
                    listagemProdutos.get(i).getNome(),
                    listagemProdutos.get(i).getValor(),
                    listagemProdutos.get(i).getStatus()
                });
            }
        } catch (Exception e) {
